          ...
          <div className="overflow-hidden rounded-[28px] border border-border bg-card shadow-float">
            <div className="border-b border-border/60 p-8 text-center">
              ...
              <div className="mt-5 flex items-baseline justify-center gap-1.5">
                <span className="font-heading text-6xl leading-none text-foreground">$499</span>
                <span className="text-[15px] text-muted-foreground">/ month</span>
              </div>
              <p className="mt-3 text-[14px] text-muted-foreground">
                Billed annually · up to 25 recruiters
              </p>
              <a
                href="#"
                className="mt-7 inline-block w-full rounded-full bg-foreground px-6 py-3.5 text-[15px] font-medium text-background shadow-float transition-transform hover:-translate-y-0.5"
              >
                Book a demo
              </a>
            </div>
