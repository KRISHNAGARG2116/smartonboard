    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-4 md:py-6">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-2 text-balance font-heading text-3xl leading-tight text-[#1f090b] md:text-4xl">
            AI Recruiting Capabilities
          </h2>
          <p className="mt-2 text-[14px] text-zinc-600 font-medium max-w-xl mx-auto">
        ...
        <Reveal delay={0.1} className="mx-auto mt-5 max-w-4xl">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            {CAPABILITIES.map((c) => {
              const Icon = c.icon
              return (
                <div key={c.title} className="rounded-2xl border border-[#e4d9ce] bg-white p-4 shadow-soft flex gap-4">
                  <span className="grid size-8.5 shrink-0 place-items-center rounded-xl bg-[#faf7f2] text-[#4a1f2c] border border-[#e4d9ce]/40">
