        ...
        with tenant_context(auth_mode="true"):
            with db_engine.connect() as conn:
                with conn.begin():
                    ...
                    for table in ("verification_tokens", "candidate_profiles", "application_snapshots", "company_trust_metrics", "onboarding_portal_tokens", "onboarding_document_signatures", "onboarding_task_reminders", "onboarding_task_escalations", "onboarding_activity_log", "employee_sync_history", "dlq_records", "hris_field_mappings", "sync_metrics", "company_subscription_plans", "company_usage_ledgers", "company_usage_histories", "company_ip_whitelists", "company_smtp_settings", "webhook_delivery_logs", "webhook_subscriptions", "approval_step_escalations", "approval_escalation_rules", "candidate_stage_sla_trackers", "stage_slas", "approval_steps", "approval_chains", "approval_template_steps", "approval_templates", "stage_definitions", "pipelines", "pipeline_templates", "oauth_states", "interview_slots", "scheduling_links", "calendar_credentials", "company_sso_settings", "export_jobs", "ai_insight_interactions", "ai_recruiter_insights", "recruiter_productivity_aggregates", "funnel_aggregates", "candidate_stage_transitions", "candidate_embeddings", "offers", "scorecards", "interviews", "candidate_notes", "audit_logs", "applications", "candidates", "jobs", "onboarding_event_outbox", "onboarding_documents", "onboarding_tasks", "onboarding_workflows", "onboarding_template_tasks", "onboarding_templates", "employees", "company_hris_integrations", "users", "companies"):
