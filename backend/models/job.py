...
from sqlalchemy import Date, DateTime, Enum, ForeignKey, String, Text, Integer, func
...
class Job(Base):
    ...
    job_version: Mapped[int] = mapped_column(Integer, default=1, server_default="1", nullable=False)
